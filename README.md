...
| Personal dashboard | Signed-in researchers can create named collections and assign only explicitly synced citations. Collection deletion preserves the citations; disconnecting citation sync deletes all account-backed collections and synced citations while leaving local browser entries unchanged. |
